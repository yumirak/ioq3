...
static qboolean CG_RegisterClientModelname( clientInfo_t *ci, const char *modelName, const char *skinName, const char *headModelName, const char *headSkinName, const char *teamName ) {
	...
	if ( CG_FindClientHeadFile( filename, sizeof(filename), ci, teamName, headName, headSkinName, "icon", "png" ) ) {
...
static qboolean CG_IsKnownModel( const char *modelName ) {
	...
	if ( Q_stricmp(modelName, "anarki") &&
		 ...
		 Q_stricmp(modelName, "james") &&
		 Q_stricmp(modelName, "janet") &&
